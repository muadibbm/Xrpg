...
function Environment() {
    ...
    this.prepare = function () {
        ...
        caveBitmap.setTransform(Const.WORLD_WIDTH - caveBitmap.image.width / 2.0 * Const.DEEVE_CAVE_SCALE - Const.WORLD_WIDTH/30.0, Const.WORLD_HEIGHT / 2.0 - caveBitmap.image.height / 2.0 * Const.DEEVE_CAVE_SCALE, Const.DEEVE_CAVE_SCALE, Const.DEEVE_CAVE_SCALE);
